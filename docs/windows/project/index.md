...
function createProject(projectid) {
	...
	let project = data.windows[projectid];
	...
	image.src = '../../windows/images/'+project[4]; // Assuming the first column in the sheet is the image name
	image.alt = project[1]; 
	...
	// 		img.src = '../../windows/project/images/'+image.trim();
	// 		img.alt = project[1];
